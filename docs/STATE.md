...
| Recipes API layer | Completed | First application feature |
| Recipe Detail | Planned | Depends on API layer |
| Home | Planned | Categories, random, recently viewed |
| Search | Completed | UI designed + API integrated |
| Saved Recipes | Planned | MMKV + Zustand |
| Profile | Planned | Local name/avatar |

## Current Focus

Refining the application features (Search completed, moving to Home/Recipe Detail).
